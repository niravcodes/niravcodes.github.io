...
C.ontouchstart=C.onkeydown=(e)=>{e.preventDefault();P?(P=0)&(S=1)&((new Image()).src=`https://flappymillennial2.azure-api.net/flappymillennial/score/${S}/none/none/${Date.now()}`)&(LP()):vy=-8};
</script>
