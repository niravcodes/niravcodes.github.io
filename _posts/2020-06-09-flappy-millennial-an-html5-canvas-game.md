...
C.ontouchstart=C.onkeydown=(e)=>{e.preventDefault();P?(P=0)&(S=1)&(sendBeacon(`https://flappymillennial2.azure-api.net/flappymillennial/score/${S}/none/none/${Date.now()}`))&(LP()):vy=-8};
</script>
